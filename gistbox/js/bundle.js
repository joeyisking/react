...
React.render(React.createElement(_GistBox2.default, null), document.body);
	...
	render: function render() {
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement('input', { value: this.state.username, onChange: this.onChange, onplaceholder: 'Type a GitHub username...' }),
				React.createElement(
					'button',
					null,
					'Fetch Latest Gist'
